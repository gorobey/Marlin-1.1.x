...
#define CUSTOM_MACHINE_NAME "Goro.Arms"
...
// repetible commenads (define here and use variables!)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // My A20 custom values
  //calulcate with: M303 E0 C10 S205 U1 ;than use M500 for store values
  #define  DEFAULT_Kp 33.33  //11.93 / 28.39
  #define  DEFAULT_Ki 4.57  //0.59 / 3.21 
  #define  DEFAULT_Kd 60.74  //59.89 / 62.80
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 121.45   // 175.68 189.95 / 182.46
  #define  DEFAULT_bedKi 17.44    //  34.59  37.40 / 35.92
  #define  DEFAULT_bedKd 211.41   // 223.07 241.19 /231.70
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.8, 400, 102.6 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.945 // Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 20

// X and Y axis travel speed (mm/m) between probes
#define XY_PROBE_SPEED 1250
...
#define HOMING_FEEDRATE_Z  (4*60)//3Dtouch---5
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS+3), Y_MAX_POS+5, 10 } //z : current pos + unit
